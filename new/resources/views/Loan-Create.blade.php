        ...
        <div class="col-md-8">
                <div class="row">
                        <div class="col-12 col-md-4 mb-3">
                                <div class="undefined"><label for="name" class="form-label">Loan Request</label><input class="form-control validation undefined " name="custom" placeholder="Select Loan Request" data-validation="" readonly="" value=""></div>
                        </div>
                        <div class="col-12 col-md-4 mb-3">
                                <div class="mb-3"><label class="form-label">Type<strong class="text-danger">*</strong></label><select class="form-select">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                                <div class="undefined"><label for="name" class="form-label">Loan Product<strong style="color: red;">*</strong></label><input class="form-control validation undefined " name="loan_product" placeholder="Select Loan Product" data-validation="" readonly="" value=""></div>
                        </div>
                        <div class="col-12 col-md-4 mb-3">
                                <div class="undefined"><label for="name" class="form-label">Referred By</label><input class="form-control validation undefined " name="custom" placeholder="Select Referred By" data-validation="" readonly="" value=""></div>
                        </div>
                        <div class="col-12 col-md-4">
                                <div class="mb-3"><label for="amount" class="form-label">Loan Amount <strong style="color: red;">*</strong></label><input class="form-control validation mx-1 undefined" step="1" placeholder="Amount" name="max_amount" min="0" type="text" value="0"><b class="text-danger"><br></b></div>
                        </div>
                        <div class="col-12 col-md-4 mb-3"><label for="interest_id" class="form-label">Loan Duration</label><select class="form-select" name="interest_id" placeholder="To Date" aria-label="Default select example"></select></div>
                        <div class="col-12 col-md-4 mb-3"><label for="number_of_payments" class="form-label">Number of Payments <strong style="color: red;">*</strong></label><input class="form-control mx-1 validation undefined" placeholder="Number of Payments" type="number" min="0" disabled="" value="0"></div>
                        <div class="col-12 col-md-4 mb-3">
                                <div class="undefined"><label for="name" class="form-label">Business / Reason<strong style="color: red;">*</strong></label><input class="form-control validation undefined " name="reason" placeholder="Select Business / Reason" data-validation="" readonly="" value=""></div>
                        </div>
                        <div class="col-12 col-md-4 mb-3"><label for="note" class="form-label">Note</label><textarea class="form-control mx-1  undefined" name="note"></textarea></div>
                        <div class="row border-top-1 m-0 pt-4 mt-2">
                                <div class="col-12 col-md-3 offset-md-9 d-flex"><button type="button" class="btn btn-primary-inverse w-100 mx-1">RESET</button><button type="submit" class="btn btn-primary w-100 mx-1">SAVE</button></div>
                        </div>
                </div>
        </div>
        <div class="col-md-4">
                <div class="row">
                        <div class="col-lg-12 col-12 d-tile">
                                <div class="my-2 p-3 bg-body rounded shadow-md d-flex">
                                        ...
                                        <div class="text-dash ms-3">
                                                <h1 class="m-0 my-1 text-break">LKR&nbsp;0.00</h1>
                        ...
                        <div class="col-lg-12 col-12 d-tile">
                                <div class="my-2 p-3 bg-body rounded shadow-md d-flex">
                                        ...
                                        <div class="text-dash ms-3">
                                                <h1 class="m-0 my-1 text-break">0%</h1>
                        ...
                        <div class="col-lg-12 col-12 d-tile">
                                <div class="my-2 p-3 bg-body rounded shadow-md d-flex">
                                        ...
                                        <div class="text-dash ms-3">
                                                <h1 class="m-0 my-1 text-break">0 | LKR&nbsp;0.00</h1>
